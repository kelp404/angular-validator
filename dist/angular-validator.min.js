...
b.validatorRequired=!1});f.$observe("required",function(a){if(a&&"false"!==a)return k(),b.required=!0;if(b.required)return l("required"),b.required=!1});h=function(b,c){var e,d;if(c){if(b.targetScope===g)return 0===f.ngModel.indexOf(c);e=function(a,b){var c,d;for(c in a)switch(d=a[c],typeof d){case "string":if("$$hashKey"===c&&d===b)return!0;break;case "object":if(e(d,b))return!0}return!1};d=f.ngModel.indexOf(".");d=0<=d?f.ngModel.substr(0,d):f.ngModel;d=a(d)(g);return e(a(c)(b.targetScope),d.$$hashKey)}return!0};
