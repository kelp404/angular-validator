...
RegExp?d=function(a,c,d,f,e){return b.test(a)?"function"===typeof e.success?e.success():void 0:"function"===typeof e.error?e.error():void 0}:"function"===typeof b&&(d=function(a,c,d,f,e){return q.all([b(a,c,d,f,g)]).then(function(a){return a&&0<a.length&&a[0]?"function"===typeof e.success?e.success():void 0:"function"===typeof e.error?e.error():void 0})});return d};this.convertRule=function(b,d){var a;null==d&&(d={});a={name:b,enableError:"watch"===d.invoke,invoke:d.invoke,filter:d.filter,validator:d.validator,
error:d.error,success:d.success};null==a.filter&&(a.filter=function(a){return a});null==a.validator&&(a.validator=function(){return!0});null==a.error&&(a.error="");a.error=h.convertError(a.error);a.success=h.convertSuccess(a.success);a.validator=h.convertValidator(a.validator);return a};this.register=function(b,d){null==d&&(d={});return this.rules[b]=this.convertRule(b,d)};this.getRule=function(b){return this.rules[b]?this.rules[b]:null};this.validate=function(b,d){var a,c,m,f,e,k,l;l=q.defer().promise;
e=f=m=0;a=[];c=[];l.success=function(b){a.push(b);return l};l.error=function(a){c.push(a);return l};k={model:d,accept:function(){return m++},success:function(){var b,c,d;if(++f===m)for(c=0,d=a.length;c<d;c++)b=a[c],b()},error:function(){var a,b,d;if(0===e++)for(b=0,d=c.length;b<d;b++)a=c[b],a();return e}};b.$broadcast(h.broadcastChannel.prepare,k);r(function(){var c,d,e;if(0===m)for(d=0,e=a.length;d<e;d++)c=a[d],c();else return c=g.get("$validator"),b.$broadcast(c.broadcastChannel.start,k)});return l};
this.get=function(b){this.setupProviders(b);return{rules:this.rules,broadcastChannel:this.broadcastChannel,convertRule:this.convertRule,getRule:this.getRule,validate:this.validate}};this.get.$inject=["$injector"];return this.$get=this.get})}).call(this);
